        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper ">
                <div class="page-content ">
                    ...
                    <h1 class="">
                        Ver Servicios Registrados<small>	<?php $curdate=date("d/m/Y"); echo  $curdate; ?> </small>
                    </h1>
                        ...
                        <div class="card mb-3" style="margin-left:35px">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"></p> <br>
                                    <center><a href="habitacionListar.php" class="btn btn-primary ">Ver</a></center>
                        ...
                        <div class="card mb-3" style="margin-left:35px">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"> <br>
                                    <center><a href="toursListar.php" class="btn btn-primary ">Ver</a></center>
                                </p>
                                <p class="card-text"><small class="text-muted"></small></p>
                            </div>
                        </div>
