...
if(!isset($_SESSION['admin'])){
	...
	if(isset($_GET['id'])){
        ...
        $buscar_id=$con->prepare('SELECT * FROM tours WHERE id=:id LIMIT 1');
		...
		header('Location: toursListar.php');
	}
	...
	if(isset($_POST['guardar'])){
        ...
        $valor=$_POST['valor'];
        $name_img1=$_POST['name_img1'];
        $img1=$_POST['img1'];
        $name_img2=$_POST['name_img2'];
        $img2=$_POST['img2'];
        $name_img3=$_POST['name_img3'];
        $img3=$_POST['img3'];
		$id=(int) $_GET['id'];

		if(!empty($name) && !empty($description) && !empty($duration) && !empty($valor)){
			
				$consulta_update=$con->prepare('UPDATE tours SET  
					name =:name,
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper ">
                <div class="page-content ">
                    ...
                    <h1 class="">
                        Registrar Tours<small>	<?php $curdate=date("d/m/Y"); echo  $curdate; ?> </small>
                    </h1>
                ...
                <div class="col-md-12">
                    <div class="card card-topline-blue">
                        ...
                        <div class="table-responsive">
										<form action="" method="post" style=" margin-top:1%; margin-bottom:3%;" enctype="multipart/form-data"> 
											<div class="container">
                                                ...
                                                <div class="" style="text-align:center;">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="nameT" value="<?php if($row) echo $row['name']; ?>" >
                                                            </div>

                                                            <div class="col-md-6">
                                                                <label>Descripción</label>
                                                                <input type="text" class="form-control" name="description" value="<?php if($row) echo $row['description']; ?>">
                                                            </div>
													...
													<div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="duration" value="<?php if($row) echo $row['duration']; ?>" >
                                                            </div>

                                                            <div class="col-md-6">
                                                                <label>Valor</label>
                                                                <input type="text" class="form-control" name="valor" value="<?php if($row) echo $row['valor']; ?>" >
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="name_img1" value="<?php if($row) echo $row['name_img1']; ?>" >
                                                            </div>

                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="img1" value="<?php if($row) echo $row['img1']; ?>" >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="name_img2" value="<?php if($row) echo $row['name_img2']; ?>" >
                                                            </div>

                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="img2" value="<?php if($row) echo $row['img2']; ?>" >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="name_img3" value="<?php if($row) echo $row['name_img3']; ?>" >
                                                            </div>

                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="img3" value="<?php if($row) echo $row['img3']; ?>" >
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="btn__group" style=" margin-left: 40%; " >
                                                    <a href="sRegistrar.php" class="btn btn-circle btn-danger">Cancelar</a>
