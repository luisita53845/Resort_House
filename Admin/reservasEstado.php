<?php
	...
	/*$sentencia_select=$con->prepare('SELECT *FROM roombook WHERE (estado = "Not Conform") ORDER BY id ASC');
	$sentencia_select->execute();
    $resultado=$sentencia_select->fetchAll();*/
    
    $sql = "SELECT * FROM roombook WHERE (stat= 'Not Conform') ";
    $resultado = mysqli_query($con,$sql);
    $c =0;

    $sqll = "SELECT * FROM reservationtour WHERE (stat= 'Not Conform') ";
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper ">
                ...
                <h1 class="">
                    Reservas por Confirmar<small>	<?php $curdate=date("d/m/Y"); echo  $curdate; ?> </small>
                </h1>
                                        ...
                                        <table class="table table-striped custom-table table-hover">
                                            ...
                                            <?php foreach($resultado as $fila):?>
                                                <tr >
                                                    ...
                                                    <td><?php echo $fila['TRoom']; ?></td>
                                                    <td>Sin Confirmar</td>
                                                    <td><a href="roombook.php?rid=<?php echo $fila['id']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa fa-pencil"></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="card-body ">
                                    <div class="table-responsive">
                                        <table class="table table-striped custom-table table-hover">
                                            ...
                                            <tbody>
                                            <?php foreach($resultadoo as $filaa):?>
                                                <tr >
                                                    <td><?php echo $filaa['id']; ?></td>
                                                    <td><?php echo $filaa['FName']; ?></td>
                                                    <td><?php echo $filaa['Email']; ?></td>
                                                    <td><?php echo $filaa['TTour']; ?></td>
                                                    <td>Sin Confirmar</td>
                                                    <td><a href="reservationTour.php?rid=<?php echo $filaa['id']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa fa-pencil"></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
                                            </tbody>
                                        </table>
