                ...
                <div class="col-md-12">
                    <div class="card card-topline-blue">
                        ...
                        <div class="table-responsive">
										<form action="validar_img.php" method="post" style=" margin-top:1%; margin-bottom:3%;" enctype="multipart/form-data"> 
											<div class="container">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="name_img1"  >
                                                            </div>
                                                ...
                                                <div class="btn__group" style=" margin-left: 40%; " >
                                                    ...
                                                    <input type="submit" name="submit" value="Registrar" class="btn btn-circle btn-success">
                                                </div>
										</form>
                                    </div>
                        </div>
