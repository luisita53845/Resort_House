<?php
	...
	/*$sentencia_select=$con->prepare('SELECT *FROM roombook WHERE stat == "Conform" ORDER BY id_reserva ASC');
	$sentencia_select->execute();
    $resultado=$sentencia_select->fetchAll();*/
    
    $sql = "SELECT * FROM roombook WHERE (stat= 'Conform') ";
    $resultado = mysqli_query($con,$sql);

    $sqll = "SELECT * FROM reservationtour WHERE (stat= 'Conform') ";
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper ">
                ...
                <h1 class="">
                    Reservas Confirmadas<small>	<?php $curdate=date("d/m/Y"); echo  $curdate; ?> </small>
                </h1>
                                        ...
                                        <table class="table table-striped custom-table table-hover">
                                            ...
                                            <?php foreach($resultado as $fila):?>
                                                <tr >
                                                    ...
                                                    <td>Confirmada</td>
                                                    <td><a href="print.php?id=<?php echo $fila['id']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa-file-text-o"></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
                                            </tbody> 
                                        </table>
                                        ...
                                        <table class="table table-striped custom-table table-hover">
                                            ...
                                            <?php foreach($result as $filaa):?>
                                                <tr >
                                                    ...
                                                    <td>Confirmada</td>
                                                    <td><a href="printTour.php?id=<?php echo $filaa['id']; ?>"  class="btn btn-primary btn-xs btn__update " ><i class="fa-file-text-o"></i></a></td>
                                                </tr>
                                                <?php endforeach ?>
                                            </tbody> 
                                        </table>
