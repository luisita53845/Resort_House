        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper ">
                <div class="page-content ">
                    ...
                    <h1 class="">
                        Servicios No Incluidos<small>	<?php $curdate=date("d/m/Y"); echo  $curdate; ?> </small>
                    </h1>
                    ...
                    <div class="card-group" style="padding-right:0px; margin-top:20px;">
                        <div class="card mb-3" >
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" style="height:345px;">
                                    <div class="carousel-item active" style="height:345px;">
                                    <img src="assets/img/servicios/comidas/img2.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/comidas/img1.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/comidas/img3.jpg" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"> Cada vez más, los hoteles ofrecen buffet libre en sus desayunos, lo que lleva consigo la aparición de huevos fritos o revueltos, 
                                    tortitas, bollería, fruta fresca, tostadas, cereales… ¡Todo lo que puedas imaginarte! ¿Dulce o salado?, no importa de qué equipo seas. 
                                    ...
                                    <center><a href="sComida.php" class="btn btn-primary ">Ver más</a></center>
                        ...
                        <div class="card mb-3" style="margin-left:35px">
                            ...
                            <ol class="carousel-indicators">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img src="assets/img/servicios/habitaciones/suite/img2.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/habitaciones/twin/img1.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/habitaciones/suiteFamiliar/img2.jpg" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Escoger el alojamiento es una de las claves fundamentales, uno de los primeros puntos de la lista a tener 
                                    ...
                                    <center><a href="habitacion.php" class="btn btn-primary ">Ver más</a></center>
                                <p class="card-text"><small class="text-muted"></small></p>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3" style="margin-left:35px">
                            <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" style="height:345px;">
                                    <div class="carousel-item active" style="height:345px;">
                                    <img src="assets/img/servicios/tours/tour4.jpg" class="d-block w-100" alt="..." >
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/tours/tour3.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/servicios/tours/tour2.jpg" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                                <a class="carousel-control-prev" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"> Muchos viajeros reservan los tours que se encargan de los lugares de atracción y se encargan de buscar otras actividades para hacer, ya sea ir a un concierto, festival, visitar una playa, entre otras. 
                                    ...
                                    <br><br>Te esperamos en nuestro Hotel </p> <br>
                                    <center><a href="sTours.php" class="btn btn-primary ">Ver más</a></center>
                                </p>
                                <p class="card-text"><small class="text-muted"></small></p>
                            </div>
                        </div>
