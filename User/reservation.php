...
<head>
    ...
    <title>Reservas | Habitación</title>
    <!-- icons -->
                            ...
                            <div class="card card-topline-blue">
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="table-responsive">
										<form action="" method="post" id="basic-form" style=" margin-top:1%; margin-bottom:3%;">
											<div class="container">
                                                ...
                                                <div class="" style="text-align:center;">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label>Nombre</label>
                                                                <input type="text" class="form-control" name="fname" placeholder="Nombre Completo">
                                                            </div>
                                                        </div>
                                                    </div>
													<div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="meal" class="form-control"required>
                                                                    ...
                                                                    <option value="Half Board">Madia Mañana y Tarde</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row" >
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input name="cout" type ="date" min=<?php echo $hoy;?> class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row" >
                                                            <div class="col-md-6" >
                                                                <label>Verificación Humana</label> <small>(Escriba debajo de este código)</small>
                                                ...
                                                <div class="btn__group" style=" margin-left: 40%; " >
                                                    <a href="habitacion.php" class="btn btn-circle btn-secondary">Cancelar</a>
