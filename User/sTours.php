...
<head>
    ...
    <title>Resort House | Servicios | Tours</title>
    <!-- icons -->
                            ...
                            <div class="card card-topline-blue ">
                                ...
                                <div class="row " style="margin: auto; height: 100% ">
                                    <div class="col-lg-6 " style="margin-top: 3%; font-size: 15px; ">
                                        <h3 class="text-info " style="margin: auto; text-align: center; margin-bottom: 2%; ">--------&nbsp;&nbsp; '.$row["name"].' &nbsp;&nbsp;--------</h3>
                                    ...
                                    <div class="col-lg-4 " style="width: 40%; margin-top: 3%; font-size: 15px; text-align: justify; float: right; ">
                                        ...
                                        <ul class="sub-menu " style="list-style: none; -moz-column-count: 2; -moz-column-gap: 20px; -webkit-column-count: 2; -webkit-column-gap: 20px; column-count: 2; column-gap: 20px; ">
                                            ...
                                            <li class="nav-item ">
                                                ...
                                                <span class="title ">Tiempo - '.$row["duration"].' </span>
                                            </li>

                                            <li class="nav-item ">
                                                <i class="material-icons " style="font-size: large; margin-right: 5px; color: orange; ">beenhere</i>
                                                <span class="title ">Precio - $'.$row["valor"].' </span>
                                            </li>
                                ...
                                <div style="margin-left: 15%; margin-top: 2.5%; margin-bottom: 2.5%; ">
                                    <img class=" d-inline p-2 " src="../Admin/'.$row["img1"].'" alt="'.$row["name_img1"].'"  width="300 " height="200 " alt="... " style="border: #1f7291 10px solid; margin-left: 50px; float: left; margin-right: 15px; ">
                                    <img class=" d-inline p-2 " src="../Admin/'.$row["img2"].'" alt="'.$row["name_img2"].'"  width="300 " height="200 " alt="... " style="border: #1f7291 10px solid; margin-left: 50px; float: left; margin-right: 15px; ">
                                    <img class=" d-inline p-2 " src="../Admin/'.$row["img3"].'" alt="'.$row["name_img3"].'"  width="300 " height="200 " alt="... " style="border: #1f7291 10px solid; margin-left: 50px; float: left; margin-right: 15px; ">
                                </div>
